...
exports.syncIgInsights = void 0;
const functions = require("firebase-functions");
const admin = require("firebase-admin");
const igApi_1 = require("./lib/igApi");
const db = admin.firestore();
// 每天台灣時間凌晨 3:30 執行（比 FB sync 晚 30 分鐘）
exports.syncIgInsights = functions
    .region('asia-east1')
...
async function syncUserIgMedia(uid, igUserId, pageToken) {
    const mediaList = await (0, igApi_1.fetchIgMedia)(igUserId, pageToken);
    ...
    for (const media of mediaList) {
        let insights;
        try {
            insights = await (0, igApi_1.fetchIgMediaInsights)(media.id, media.media_type, pageToken);
        }
        catch (err) {
...
//# sourceMappingURL=syncIgInsights.js.map