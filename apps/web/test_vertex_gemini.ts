...
async function run() {
  ...
  const url = `https://us-central1-aiplatform.googleapis.com/v1/projects/contentloop-dev/locations/us-central1/publishers/google/models/gemini-1.5-flash:generateContent`;
  ...
  console.log('Gemini 1.5 Flash result:', data.error ? data.error : 'Success!');
}
