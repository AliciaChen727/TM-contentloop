    ...
    <main style={{ maxWidth: 680, margin: '0 auto', padding: '48px 24px', fontFamily: 'system-ui, sans-serif', color: '#1e293b', lineHeight: 1.7 }}>
      ...
      <section style={{ marginBottom: 32 }}>
        ...
        <ul style={{ fontSize: 14, paddingLeft: 20 }}>
          ...
          <li style={{ marginBottom: 6 }}><strong>Messaging analytics (read-only):</strong> Aggregate counts derived from the direct messages of your own Facebook Page and connected Instagram Business account — for example, how many messages were received per day and how many distinct people messaged you. We use this only to display messaging-volume statistics; we never send, reply to, or manage conversations, and we do not disclose individual message content to any third party.</li>
