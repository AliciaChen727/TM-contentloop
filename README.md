...
| Date | Change | Commit |
|------|--------|--------|
| 2026-09-06 | **CLAUDE.md / AGENTS.md 專案定位同步改寫**：從「Toastmasters 分會用」改為「為個人品牌、企業與組織打造，一站式檢視 Meta 社群與廣告成效」，並註明第一個客戶是 TM 分會但程式與文案不可寫死單一組織；現況段更新至 Phase 3/3B/3C 交付、5 進行中；環境資訊 Meta App 改 Live mode、FB Page 改「使用者自己管理的粉專」 | （本次） |
